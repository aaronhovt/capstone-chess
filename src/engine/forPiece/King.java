...
public final class King extends Piece {
  ...
  /**
   * Returns the destination squares of this king's legal moves on the given board, being every
   * adjacent square that is empty or holds an opposing piece. Castling is generated by the
   * player rather than the king, so castling destinations are not included.
   *
